    ...
    <footer className="mt-auto border-t border-white/10 bg-neutral px-5 py-8 text-neutral-content sm:px-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-6 sm:flex-row">
        ...
        <nav aria-label="Social links" className="flex items-center gap-2">
          <a
            aria-label="DevTinder on Twitter"
            className="flex h-10 w-10 items-center justify-center rounded-full text-neutral-content/70 transition-colors hover:bg-white/10 hover:text-white"
          >
            <svg
          ...
          <a
            aria-label="DevTinder on YouTube"
            className="flex h-10 w-10 items-center justify-center rounded-full text-neutral-content/70 transition-colors hover:bg-white/10 hover:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            aria-label="DevTinder on Facebook"
            className="flex h-10 w-10 items-center justify-center rounded-full text-neutral-content/70 transition-colors hover:bg-white/10 hover:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
